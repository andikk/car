...
$(document).ready(function(){var e=document.querySelector(".js-menu"),s=document.querySelector(".js-menu__button");s.addEventListener("click",function(){e.classList.contains("js-menu_closed")?(e.classList.remove("js-menu_closed"),e.classList.add("js-menu_opened")):(e.classList.add("js-menu_closed"),e.classList.remove("js-menu_opened"))});var t=document.querySelector(".js-hero__button"),n=document.querySelector(".js-modal"),c=document.querySelector(".js-page");t.addEventListener("click",function(){n.style="display: flex;",c.classList.add("page__fade")});var o=document.querySelector(".modal__close");o.addEventListener("click",function(){c.classList.remove("page__fade"),n.style="display: none;"})});